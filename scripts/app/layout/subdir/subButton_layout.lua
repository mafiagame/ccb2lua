...
function subdir_subButton_layout:ctor(_owner)
	...
	ccmenuitemimage_3:setPosition(cc.p(96, 402))
	...
	ccmenuitemimage_4:setPosition(cc.p(356, 402))
	...
	cclabelttf_5:setPosition(cc.p(self:getContentSize().width * 0.09, self:getContentSize().height * 0.52))
	...
	cclabelttf_6:setPosition(cc.p(self:getContentSize().width * 0.37, self:getContentSize().height * 0.52))
	...
	cccontrolbutton_7:setPosition(cc.p(632, 397))
	...
	cclabelttf_8:setPosition(cc.p(self:getContentSize().width * 0.65, self:getContentSize().height * 0.52))
...
return subdir_subButton_layout