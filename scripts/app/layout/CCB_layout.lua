...
function CCB_layout:ctor(_owner)
	...
	self._title:setPosition(ccbutils.ccb_pos(50.180000305175781,89.375,4,self))
	...
	self._num1:setPosition(ccbutils.ccb_pos(150.33601379394531,452.73605346679688,0,self))
	...
	self._num2:setPosition(ccbutils.ccb_pos(340.33599853515625,452.73605346679688,0,self))
	...
	self._num3:setPosition(ccbutils.ccb_pos(530.33599853515625,452.73605346679688,0,self))
	...
	self._num4:setPosition(ccbutils.ccb_pos(730.33599853515625,452.73605346679688,0,self))
