...
function Layout_layout:ctor(_owner)
	...
	mask_1:setContentSize(ccbutils.ccb_size(100,100,1,self))
	...
	scroll_2:setViewSize(ccbutils.ccb_size(450,500,0,self))
	scroll_2:setDirection(kCCScrollViewDirectionVertical)
	scroll_2:setAnchorPoint(cc.p(0.5,0.5))
	scroll_2:setPosition(ccbutils.ccb_pos(240.31999206542969,340.16000366210938,0,self))
	...
	scroll_3:setViewSize(ccbutils.ccb_size(450,500,0,self))
	scroll_3:setDirection(kCCScrollViewDirectionHorizontal)
	scroll_3:setAnchorPoint(cc.p(0.5,0.5))
	scroll_3:setPosition(ccbutils.ccb_pos(721.1424560546875,336.20159912109375,0,self))
	...
	ttf_4:setPosition(ccbutils.ccb_pos(174.18241882324219,35.888031005859375,0,self))
	...
	ttf_5:setPosition(ccbutils.ccb_pos(734.169677734375,41.011241912841797,0,self))
